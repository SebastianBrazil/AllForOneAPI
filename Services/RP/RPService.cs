...
namespace AllForOneAPI.Services.RP;

public class RPService : IRPService
{
    public string Pick(string catgory)
    {
        ...
        if (reply == "seafood")
        {
            ...
            return $"You chose the category {reply}." + NewLine +  $"The restaurant you are going to is {seafood[bobbert]}";
        }
        else if (reply == "steakhouse" || reply == "steakhouses")
        {
            ...
            return $"You chose the category {reply}." + NewLine +  $"The restaurant you are going to is {steakhouses[bobbert]}";
        }
        else if (reply == "chinese")
        {
            ...
            return $"You chose the category {reply}." + NewLine +  $"The restaurant you are going to is {chinese[bobbert]}";
        }
        else
        {
            return $"You chose the category {reply}." + NewLine +  $"It is not a valid category...Only seafood, chinese, and steakhouse are vaild.";
        }
    }
}